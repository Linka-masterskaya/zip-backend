...
// fake-зависимость вместо реального smtp.
// необходим для проверки: сервис попытался отправить verify-письмо, на правильный email, с правильным шаблоном и токеном.
...
// хранит количество записей в таблицах, которые должна затронуть регистрация.
