...
func (m *MockauthRepoIface) CreateOrganization(ctx context.Context, id uuid.UUID, name string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrganization", ctx, id, name)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateOrganization indicates an expected call of CreateOrganization.
func (mr *MockauthRepoIfaceMockRecorder) CreateOrganization(ctx, id, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrganization", reflect.TypeOf((*MockauthRepoIface)(nil).CreateOrganization), ctx, id, name)
}
...
// InvalidateAllVerifyTokens mocks base method.
func (m *MockauthRepoIface) InvalidateAllVerifyTokens(ctx context.Context, userID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InvalidateAllVerifyTokens", ctx, userID)
	ret0, _ := ret[0].(error)
	return ret0
}

// InvalidateAllVerifyTokens indicates an expected call of InvalidateAllVerifyTokens.
func (mr *MockauthRepoIfaceMockRecorder) InvalidateAllVerifyTokens(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InvalidateAllVerifyTokens", reflect.TypeOf((*MockauthRepoIface)(nil).InvalidateAllVerifyTokens), ctx, userID)
}
...
func (m *MockrefreshStore) Allow(ctx context.Context, req cache.RateLimitRequest) (bool, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockrefreshStoreMockRecorder) Allow(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Allow", reflect.TypeOf((*MockrefreshStore)(nil).Allow), ctx, req)
}
